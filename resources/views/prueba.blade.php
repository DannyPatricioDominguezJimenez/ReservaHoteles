...
<body>
    ...
    <div class="relative w-full h-96">
        <img class="absolute h-full w-full object-cover object-center" src="{{ asset('imagenes/Contactanos.jpg') }}"
            alt="nature image" />
        <div class="absolute inset-0 h-full w-full bg-black/50"></div>
        <div class="absolute inset-0 flex flex-col justify-center items-center text-center text-white px-4">
            <h2
                class="block antialiased tracking-normal font-sans font-semibold leading-[1.3] mb-4 text-3xl lg:text-4xl">
    ...
    <section class="pt-16">
        <div class="container mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-2 gap-8 bg-white rounded-lg shadow-lg">
            ...
            <div class="map-container bg-gray-100 rounded-lg">
                <div class="map">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3021.8648591545734!2d-74.00601568501109!3d40.7127760793317!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDAnNDInNDQuMCJOIDc0wrAwMCcwMC4wIlc!5e0!3m2!1sen!2s!4v1628238745098!5m2!1sen!2s"
    ...
    <!-- Sección del clima en Esmeraldas -->
    <section class="pt-16">
        <div class="container mx-auto px-4 py-10 bg-white rounded-lg shadow-lg">
            <h2 class="text-3xl font-semibold text-center mb-8">Clima en Esmeraldas, Ecuador</h2>
            @if(isset($error))
            <p class="text-red-500 text-center">{{ $error }}</p>
            @else
            <div class="text-center">
                <p class="text-lg">El clima en <strong>{{ $city }}</strong> es <strong>{{ $weatherDescription }}</strong>
                    con una temperatura de <strong>{{ $temperature }}°C</strong>.</p>
            </div>
            @endif
        </div>
    </section>
