...
use App\Filament\Resources\CuadruplesResource\Pages;
use App\Filament\Resources\CuadruplesResource\RelationManagers;
...
class CuadruplesResource extends Resource
{
    protected static ?string $model = Cuadruples::class;
    ...
    {
        return [
            'index' => Pages\ListCuadruples::route('/'),
            'create' => Pages\CreateCuadruples::route('/create'),
            'edit' => Pages\EditCuadruples::route('/{record}/edit'),
        ];
    }
}
